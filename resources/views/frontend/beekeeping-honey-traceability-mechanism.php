...
<head>
  ...
  <title>Beekeeping and Honey Traceability Mechanism</title>
...
<body>
 ...
 <main class="internal-pages">
     <section class="internal-banner-slide">
          <div class="container">
           <h1>Beekeeping and Honey Traceability Mechanism</h1>
           </div>
     </section>
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 dkd-machine">
            <p>With tremendous export possibilities and exceptional healing capacity, honey is sincerely benefiting our physical and financial health. However, the room for refinement in production and procurement activities cannot be denied. Acknowledging this situation Samriddha Gram has designed a system to support beekeepers so high-quality honey could be procured in the smoothest possible manner. This system provides accurate traceability of honey from the farm to your spoon. We will now describe the procedure systematically! </p>
           <p>Challenges faced by beekeepers</p>
            <ul>
                <li>Technological backwardness </li>
 <li>Poor marketing structure </li>
 <li>Insufficient awareness </li>
            </ul>
...
<p>To resolve these issues, Samriddha Gram has developed a unique mechanism that collectively solves the major and minor issues prevalent in this sector. As per the NBHM (National Beekeeping and Honey Mission) under MSME (Ministry of Micro, Small and Medium Enterprises), we are focused on helping the entire beekeeping economy rise. This process takes help from two platforms stated ahead. </p>
   <p>In an effort to ensure quality and prevent adulteration, the Union Agriculture Ministry launched a portal for online registration to create a traceability system for procuring honey and other beehive products. The National Bee Board (NBB) under the National Beekeeping and Honey Mission (NBHM) was launched as an online portal called “Madhukranti” in the year 2021. This portal was created to maintain a database of all stakeholders involved in the Honey production, sales, and marketing chain. As of now, a total of 13099 beekeepers, 159 beekeeping and honey societies, 109 firms, and 102 companies are registered on the MadhuKranti portal.</p>
        ...
        <div class="col-lg-5">
         <img src="assets/img/Honey-Bee-B.webp">
