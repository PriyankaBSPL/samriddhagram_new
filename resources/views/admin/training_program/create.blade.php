            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Traing Program</li>
                    </ol>
                </div>
            </div>
        </div> <!--/.container-fluid  -->
                        ...
                        <form method="POST" action="{{ route('training.store') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="startdate" class="form-control @error('startdate') is-invalid @enderror" value="{{old('startdate')}}" id="startdate">
                                ...
                                <div class="form-group">
                                    ...
                                    <span style="color: red;" class="star">*</span>
                                    <input type="date" name="enddate" class="form-control @error('enddate') is-invalid @enderror" value="{{old('enddate')}}" id="enddate">
                                ...
                                <div class="form-group">
                                    ...
                                    <span style="color: red;" class="star">*</span>
                                    <textarea name="beneficiaries" class="form-control" id="beneficiaries">{{ old('beneficiaries') }}</textarea>
